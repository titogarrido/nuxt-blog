---
title: How to use Terraform and KVM (libvirt)
description: This article provides a step-by-step guide on how to create a KVM virtual environment using the Terraform libvirt provider. Updated to support Terraform 0.11.14 and libvirt provider 0.5.1, it offers detailed instructions for setting up infrastructure without needing a cloud account.
